...
var $author$project$IorinParser$Failed = {$: 'Failed'};
...
var $author$project$Main$evaluate = F2(
	function (dict, logExp) {
		switch (logExp.$) {
			case 'Var':
				var c = logExp.a;
				return A2(
			...
			case 'And':
				var e1 = logExp.a;
				var e2 = logExp.b;
				return A2($author$project$Main$evaluate, dict, e1) && A2($author$project$Main$evaluate, dict, e2);
			case 'Or':
				var e1 = logExp.a;
				var e2 = logExp.b;
				return A2($author$project$Main$evaluate, dict, e1) || A2($author$project$Main$evaluate, dict, e2);
			...
			case 'Iff':
				...
				var e2 = logExp.b;
				return _Utils_eq(
					A2($author$project$Main$evaluate, dict, e1),
					A2($author$project$Main$evaluate, dict, e2));
			default:
				var bool = logExp.a;
				return bool;
		}
...
var $author$project$IorinParser$Success = F2(
	function (a, b) {
		return {$: 'Success', a: a, b: b};
	});
var $author$project$IorinParser$char = function (f) {
	return function (str) {
		...
		if (_v0.$ === 'Just') {
			...
			var hd = _v1.a;
			var tl = _v1.b;
			return f(hd) ? A2($author$project$IorinParser$Success, hd, tl) : $author$project$IorinParser$Failed;
		} else {
			return $author$project$IorinParser$Failed;
		}
	};
};
var $author$project$IorinParser$fmap = F2(
	function (f, pa) {
		return function (str) {
			var _v0 = pa(str);
			if (_v0.$ === 'Success') {
...
var $author$project$IorinParser$charMatch = function (c) {
	return A2(
		...
		$author$project$IorinParser$char(
...
var $author$project$Main$closeParen = A2(
	...
	$author$project$IorinParser$char(
		$elm$core$Basics$eq(
			_Utils_chr(')'))));
var $author$project$IorinParser$concat = F3(
	function (pa, pb, f) {
		return A2(
			$author$project$IorinParser$fmap,
			function (a) {
...
var $author$project$IorinParser$intersperseConcat = F4(
	function (i, p1, p2, f) {
		return A4(
			$author$project$IorinParser$concat3,
			p1,
			i,
			p2,
			F3(
...
var $author$project$IorinParser$concat4 = F5(
	function (pa, pb, pc, pd, f) {
		return A2(
			$author$project$IorinParser$fmap,
			function (a) {
				return A4(
...
var $author$project$IorinParser$concat5 = F6(
	function (pa, pb, pc, pd, pe, f) {
		return A2(
			$author$project$IorinParser$fmap,
			function (a) {
				return A5(
					$author$project$IorinParser$concat4,
					pb,
					pc,
					pd,
					pe,
...
var $author$project$IorinParser$intersperseConcat3 = F5(
	function (i, p1, p2, p3, f) {
		return A6(
			$author$project$IorinParser$concat5,
			p1,
			i,
			p2,
			i,
...
var $author$project$IorinParser$lazy = function (a) {
	return A2(
		$author$project$IorinParser$fmap,
		a,
		$author$project$IorinParser$return(_Utils_Tuple0));
};
var $author$project$Main$openParen = A2(
	$author$project$IorinParser$map,
	$elm$core$Basics$always(_Utils_Tuple0),
	$author$project$IorinParser$char(
		$elm$core$Basics$eq(
...
var $author$project$Main$pAnd = A2(
	$author$project$IorinParser$map,
	$elm$core$Basics$always($author$project$Main$And),
	$author$project$IorinParser$charMatch(
		_Utils_chr('∧')));
var $author$project$Main$Iff = F2(
	function (a, b) {
		return {$: 'Iff', a: a, b: b};
	});
var $author$project$Main$pIff = A2(
	$author$project$IorinParser$map,
	$elm$core$Basics$always($author$project$Main$Iff),
	$author$project$IorinParser$charMatch(
		_Utils_chr('⇔')));
var $author$project$Main$Imp = F2(
	function (a, b) {
		return {$: 'Imp', a: a, b: b};
	});
var $author$project$Main$pImp = A2(
	$author$project$IorinParser$map,
	$elm$core$Basics$always($author$project$Main$Imp),
	$author$project$IorinParser$charMatch(
		_Utils_chr('⇒')));
var $author$project$Main$Not = function (a) {
	return {$: 'Not', a: a};
};
var $author$project$Main$pNot = A2(
	$author$project$IorinParser$map,
	$elm$core$Basics$always($author$project$Main$Not),
	$author$project$IorinParser$charMatch(
		_Utils_chr('¬')));
...
var $author$project$Main$pOr = A2(
	$author$project$IorinParser$map,
	$elm$core$Basics$always($author$project$Main$Or),
	$author$project$IorinParser$charMatch(
		_Utils_chr('∨')));
var $author$project$Main$Var = function (a) {
	return {$: 'Var', a: a};
};
var $author$project$Main$varParser = A2(
	$author$project$IorinParser$map,
	function (c) {
...
var $author$project$Main$zeroOrMoreSpaceParser = A2(
	...
	$author$project$IorinParser$zeroOrMore(
		$author$project$IorinParser$charMatch(
			_Utils_chr(' '))));
function $author$project$Main$cyclic$parenParser() {
	return A5(
		$author$project$IorinParser$intersperseConcat3,
		$author$project$Main$zeroOrMoreSpaceParser,
		$author$project$Main$openParen,
		$author$project$Main$cyclic$logicExpressionParser(),
		$author$project$Main$closeParen,
		F3(
			function (_v6, e, _v7) {
				return e;
			}));
}
function $author$project$Main$cyclic$logicExpressionParser() {
...
function $author$project$Main$cyclic$tfOrVarOrParen() {
	return $author$project$IorinParser$choice(
		_List_fromArray(
			[
				$author$project$IorinParser$lazy(
				function (_v0) {
					return $author$project$Main$cyclic$parenParser();
				}),
				$author$project$IorinParser$lazy(
				function (_v1) {
					return $author$project$Main$cyclic$notParser();
				}),
				$author$project$Main$boolParser,
				$author$project$Main$varParser
			]));
}
try {
	var $author$project$Main$parenParser = $author$project$Main$cyclic$parenParser();
	$author$project$Main$cyclic$parenParser = function () {
		return $author$project$Main$parenParser;
	};
	var $author$project$Main$logicExpressionParser = $author$project$Main$cyclic$logicExpressionParser();
	$author$project$Main$cyclic$logicExpressionParser = function () {
		return $author$project$Main$logicExpressionParser;
	};
	var $author$project$Main$logExpParser = $author$project$Main$cyclic$logExpParser();
	...
	$author$project$Main$cyclic$notParser = function () {
		return $author$project$Main$notParser;
	};
	var $author$project$Main$tfOrVarOrParen = $author$project$Main$cyclic$tfOrVarOrParen();
	$author$project$Main$cyclic$tfOrVarOrParen = function () {
...
var $author$project$Main$search = F3(
	function (exp, result, rest) {
		search:
		while (true) {
			if (!rest.b) {
				return A2(
					$author$project$Main$evaluate,
					$elm$core$Dict$fromList(result),
					exp) ? $elm$core$Maybe$Just(result) : $elm$core$Maybe$Nothing;
			} else {
				var hd = rest.a;
				var tl = rest.b;
				var _v1 = A3(
					...
					A2(
						$elm$core$List$cons,
						_Utils_Tuple2(hd, true),
						result),
					tl);
				if (_v1.$ === 'Just') {
					var result_ = _v1.a;
					return $elm$core$Maybe$Just(result_);
				} else {
					var $temp$exp = exp,
						$temp$result = A2(
						$elm$core$List$cons,
						_Utils_Tuple2(hd, false),
						result),
						$temp$rest = tl;
					exp = $temp$exp;
					result = $temp$result;
					...
					model,
					{
						varList: A2(
							...
							function (_v1) {
								var _char = _v1.a;
								var bool = _v1.b;
								return _Utils_eq(_char, c) ? _Utils_Tuple2(_char, !bool) : _Utils_Tuple2(_char, bool);
							},
							model.varList)
					});
			default:
				...
				switch (str) {
					...
					case 'calc':
						return _Utils_update(
							model,
							{
								comment: '',
								evalResult: function () {
									var _v6 = model.result;
									if ((_v6.$ === 'Success') && (_v6.b === '')) {
										var e = _v6.a;
										return $elm$core$Maybe$Just(
											A2(
												$author$project$Main$evaluate,
					...
					case 'solve':
						var _v7 = model.result;
						if ((_v7.$ === 'Success') && (_v7.b === '')) {
							var e = _v7.a;
							var newModel = function () {
								...
								var _v9 = A3(
									...
									e,
									_List_Nil,
									$elm$core$List$reverse(charList));
								if (_v9.$ === 'Just') {
									var list = _v9.a;
									...
									evalResult: function () {
										...
										if ((_v8.$ === 'Success') && (_v8.b === '')) {
											...
											return $elm$core$Maybe$Just(
												A2(
													$author$project$Main$evaluate,
													$elm$core$Dict$fromList(newModel.varList),
													exp));
										} else {
											return $elm$core$Maybe$Nothing;
										}
...
var $author$project$Main$resultToString = function (logExp) {
	switch (logExp.$) {
		case 'Var':
			var c = logExp.a;
		...
		case 'Not':
			var e = logExp.a;
			return '(Not ' + ($author$project$Main$resultToString(e) + ' )');
		case 'And':
			var e1 = logExp.a;
			var e2 = logExp.b;
			return '(And ' + ($author$project$Main$resultToString(e1) + (', ' + ($author$project$Main$resultToString(e2) + ' )')));
		case 'Or':
			var e1 = logExp.a;
			var e2 = logExp.b;
			return '(Or ' + ($author$project$Main$resultToString(e1) + (', ' + ($author$project$Main$resultToString(e2) + ' )')));
		case 'Imp':
			var e1 = logExp.a;
			var e2 = logExp.b;
			return '(Imp ' + ($author$project$Main$resultToString(e1) + (', ' + ($author$project$Main$resultToString(e2) + ' )')));
		case 'Iff':
			var e1 = logExp.a;
			var e2 = logExp.b;
			return '(Iff ' + ($author$project$Main$resultToString(e1) + (', ' + ($author$project$Main$resultToString(e2) + ' )')));
		default:
			if (logExp.a) {
				return 'True';
			} else {
...
var $author$project$Main$makeSelectBox = F2(
	function (c, bool) {
		return A2(
			$elm$html$Html$span,
			_List_Nil,
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$checked(bool),
							$elm$html$Html$Events$onClick(
							$author$project$Main$Check(c))
						]),
					_List_Nil)
				]));
	});
var $author$project$Main$varSelectBoxList = function (li) {
	return A2(
		...
		A2(
			...
			function (_v0) {
				var c = _v0.a;
				var bool = _v0.b;
				return A2($author$project$Main$makeSelectBox, c, bool);
			},
			li));
};
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$value(model.inputStr)
						]),
					_List_Nil),
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Main$Pressed('parse'))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Parse it !')
						])),
					A2(
					$elm$html$Html$button,
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Main$Pressed('calc'))
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Main$Pressed('not'))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('¬')
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Main$Pressed('and'))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('∧')
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Main$Pressed('or'))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('∨')
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Main$Pressed('imp'))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('⇒')
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Main$Pressed('iff'))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('⇔')
					...
					function () {
						...
						if ((_v0.$ === 'Success') && (_v0.b === '')) {
							var str = _v0.a;
							return $author$project$Main$resultToString(str);
						} else {
							return 'Error';
						}
					}()),
